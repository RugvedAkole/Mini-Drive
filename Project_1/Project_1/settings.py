...
# Default to the old key for local development if .env is missing
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-lx+^e5v(#5vw^-l^a149k1u*#c-5l4rsw0)&xcm%twb@k0zkhz')

# SECURITY WARNING: don't run with debug turned on in production!
# Set DEBUG=False in your PythonAnywhere environment variables or .env
DEBUG = os.environ.get('DEBUG', 'True') == 'True'

ALLOWED_HOSTS = ['RNAOOO.pythonanywhere.com', '127.0.0.1', 'localhost']
